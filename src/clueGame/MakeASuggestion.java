	...
	public MakeASuggestion(String currentRoom, Board board) {
		...
		submitButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				Solution solution = new Solution(new Card((String)personSelection.getSelectedItem(),CardType.PERSON), new Card(currentRoom,CardType.ROOM), new Card((String)weaponSelection.getSelectedItem(),CardType.WEAPON));
